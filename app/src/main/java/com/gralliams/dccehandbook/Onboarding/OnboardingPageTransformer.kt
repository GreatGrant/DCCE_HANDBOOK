...
class OnboardingPageTransformer : ViewPager.PageTransformer {
    override fun transformPage(page: View, position: Float) {
        ...
        if (position <= -1.0f || position >= 1.0f) {
            ...
            val title = page.findViewById<View>(R.id.textView7)
            ...
            val description = page.findViewById<View>(R.id.textView8)
            ...
            val computer = page.findViewById<View>(R.id.imageView3)
