...
import com.gralliams.dccehandbook.R.string.graduation
...
class TagDisplayActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when(position){
            ...
            5 -> setText(R.string.course_duration, "file:///android_asset/duration.html", R.drawable.ic_undraw_visualization_c_2_ps)
            6 -> setText(R.string.curriculum, "file:///android_asset/curriculum.html",R.drawable.ic_undraw_education_f8ru)
            7 -> setText(R.string.grading, "file:///android_asset/grading.html",R.drawable.ic_undraw_certificate__343_v)
            else-> setText(R.string.staff_list, "file:///android_asset/staff.html",R.drawable.undraw_grades_re_j7d6)
        }
